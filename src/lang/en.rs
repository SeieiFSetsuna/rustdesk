...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the TianRen network..."),
        ...
        ("Slogan_tip", "The armed organization of the celestial beings will eradicate all disputes in the world, gather the power of the world, and prepare for a new dialogue in the future of mankind!"),
        ...
        ("install_tip", "If you want a better remote service experience, it is recommended to install it into the system service."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant TianRen \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant TianRen \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", "If a better experience is needed, installing as a system service provides a better experience."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow TianRen to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [TianRen Input] service."),
        ...
        ("doc_mac_permission", "http://tianren.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next TianRen application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant TianRen \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant TianRen \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running TianRen."),
        ...
        ("verify_rustdesk_password_tip", "Verify TianRen password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use TianRen and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade TianRen Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "http://tianren.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent TianRen from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by TianRen"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if TianRen window is open"),
        ...
        ("floating_window_tip", "It helps to keep TianRen background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the TianRen client to version {} or newer on the remote side!"),
