...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "网站"),
        ("About", "关于"),
        ("Slogan_tip", "天人武装组织，根除世上一切纷争，凝聚世界力量，向着人类未来的新对话展开准备！"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "如果想获得更好的远程服务体验，建议安装到系统服务。"),
        ...
        ("setup_server_tip", " 如果想获得更好的远程服务体验，建议安装到系统服务。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 TianRen 后台服务"),
        ...
        ("verify_rustdesk_password_tip", "验证 TianRen 密码"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 TianRen 客户端升级至版本 {} 或更新版本！"),
